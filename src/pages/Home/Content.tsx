...
function Content() {
  ...
  const summary = `I'm a front-end developer passionate about creating 
  interactive and visually engaging web experiences. I specialize in 
  React, Vite, Tailwind CSS, and Framer Motion, bringing modern designs to life with
   smooth animations and responsive layouts. Always eager to learn and improve, I focus on 
   building user-friendly interfaces that enhance the web experience;`;
  return (
    <>
      <BlurFade
        inView
      ...
      <div className="mt-20 p-4 grid lg:grid-cols-3 md:grid-cols-3 md:grid-rows-2 gap-4 max-w-4xl m-auto ">
        <BlurFade
          delay={0.15}
          inView
          className="lg:col-span-1 md:col-span-1 space-y-4 p-6 border rounded-md "
        >
        ...
        <BlurFade
          delay={0.15 * 2}
          inView
          className="lg:col-span-2 md:col-span-2 space-y-4 p-6 border rounded-md  "
        >
          <h1 className="font-bold text-xl flex items-center gap-2">
            <FaLaptopCode />
            Tech Stack
        ...
        <BlurFade
          delay={0.15 * 3}
          inView
          className="lg:col-span-1 space-y-4 p-6 border rounded-md "
        >
          <h1 className="font-bold text-xl flex items-center gap-2">
            <BsMortarboardFill />
            Education
        ...
        <BlurFade
          delay={0.15 * 4              }
          inView
          className="lg:col-span-2 md:col-span-2 p-2 border rounded-sm "
        >
          ...
          <Card
            ...
            pic={<img src="todo.png" alt="image" />}
